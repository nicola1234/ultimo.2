...
<?php } ?>
        ...
        <?php if (MS_PAGINATION_STYLE==2 && $a_customers_list->Pager->RecordCount > 0) { ?>
				<div class="ewPager ewRec">
					<span><?php echo htmlspecialchars($_SESSION['Language']->Phrase('Record')) ?>&nbsp;<?php echo $a_customers_list->Pager->FromIndex ?>&nbsp;<?php echo htmlspecialchars($_SESSION['Language']->Phrase('To')) ?>&nbsp;<?php echo $a_customers_list->Pager->ToIndex ?>&nbsp;<?php echo $_SESSION['Language']->Phrase('Of') ?>&nbsp;<?php echo $a_customers_list->Pager->RecordCount ?></span>
				</div>
		<?php } ?>
